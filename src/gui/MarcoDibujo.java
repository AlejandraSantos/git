...
public class MarcoDibujo extends JFrame{
    private final JComboBox figurasC,colorC;
    private final JCheckBox relleno;
    private final JButton limpiar,borrar;
    private final JPanel menu;
    private final PanelDibujo dibujo;
    private final JComboBox figurasCreadas;
    private final MetodosExtra metodosExtra;
    private final JButton arriba,abajo,izquierda,derecha;
